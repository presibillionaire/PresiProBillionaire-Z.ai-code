...
export function AuthSection() {
  ...
  return (
    <>
      ...
      {/* Manual Token Card */}
      <div className="w-full max-w-sm bg-gray-900/70 border border-gray-800/60 rounded-xl p-5 text-left space-y-3">
        <div className="flex items-center gap-2">
          <Key className="text-sky-400" size={14} />
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-gray-800 border border-gray-700 text-gray-200 text-sm rounded-lg px-3 py-2.5 pr-10 focus:outline-none focus:border-sky-500 placeholder-gray-600 transition-colors"
            autoComplete="off"
            spellCheck={false}
            value={tokenInput}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg font-semibold text-sm bg-sky-500 hover:bg-sky-400 text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed active:scale-95 shadow-lg shadow-sky-500/20 cursor-pointer"
        ...
        <a
          ...
          className="flex items-center justify-center gap-1.5 text-xs text-gray-500 hover:text-sky-400 transition-colors"
        >
      ...
      <p className="text-sm text-gray-600 mt-6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-sky-500 hover:text-sky-400 font-medium transition-colors underline underline-offset-2"
        >
          Open a free account
        </a>
      </p>
