  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-between bg-gray-900/60 border border-white/[0.06] rounded-xl px-4 py-3 hover:bg-gray-900/80 transition-all cursor-pointer"
      >
          ...
          {activeStrategy && (
            <>
              {(() => {
                ...
                return (
                  <div className="w-8 h-8 bg-sky-500/10 border border-sky-400/20 rounded-lg flex items-center justify-center">
                ...
                <button
                  ...
                  className={`relative flex flex-col items-start gap-2 p-3 rounded-xl border text-left transition-all cursor-pointer ${
                    isDisabled
                      ...
                      : isActive
                      ? "ring-2 ring-sky-400/40 bg-sky-500/10 border-sky-400/20"
                      : "bg-gray-900/60 border-white/[0.06] hover:bg-gray-900/80 hover:border-white/[0.1]"
                  }`}
                >
                  ...
                  {isActive && (
                    <div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-sky-400" />
                  )}
                </button>
              );
            })}
