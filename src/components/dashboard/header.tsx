    ...
    <SlideDown>
      <header className="px-4 sm:px-6 py-3 flex items-center justify-between border-b border-gray-800/50 gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            onClick={logout}
            className="text-gray-400 hover:text-red-400 border border-gray-700/60 hover:border-red-900/60 rounded-lg px-2.5 py-1.5 flex items-center gap-1.5 text-[10px] font-medium transition-all cursor-pointer hover:scale-105 active:scale-95"
          >
            <LogOut size={12} />
