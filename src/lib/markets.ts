...
export const STRATEGIES: Strategy[] = [
  {
    ...
    howToUse: {
      ...
      recommended: "Begin with Vol 10 (1s) and Vol 25 (1s) — these indices offer the most predictable digit distributions for even/odd analysis, making them ideal for building confidence with the Quantum Sweep strategy.",
    },
  },
  {
    id: "m-digit",
  ...
  },
  {
    ...
    howToUse: {
      ...
      tips: [
        ...
        "Use smaller stakes ($1–$2) when testing Neural Strike on new markets to understand their behavior",
      ...
      recommended: "Vol 25 (1s) and Vol 50 (1s) are Neural Strike's top picks — they offer the ideal balance of tick speed and distribution volatility for precise Over/Under entries.",
    },
  },
  {
    id: "digit-scanner",
    ...
    howToUse: {
      ...
      recommended: "Volatility 10 (1s) has the most consistent digit distribution, making it the top pick for Spectrum Edge. Vol 25 (1s) and Vol 75 (1s) are strong alternatives when Vol 10 shows low quality scores.",
    },
  },
  {
    id: "rise-fall",
    ...
    howToUse: {
      steps: [
        ...
        "Watch the Digit Chart for your selected market — while Velocity Tracker uses direction, digit patterns can indicate momentum shifts",
      ...
      tips: [
        ...
        "Vol 10 (1s) is the most beginner-friendly market for Velocity Tracker due to its lower volatility and smoother movements",
      ],
      recommended: "Vol 10 (1s) is the ideal starting market for Velocity Tracker beginners — its lower volatility produces cleaner directional signals. Move to Vol 25 (1s) once you're comfortable with the strategy mechanics.",
    },
  },
  {
    id: "higher-lower",
    ...
    howToUse: {
      ...
      recommended: "Vol 50 and Vol 75 standard markets (R_50, R_75) are the top choices for Horizon Pro — they offer sufficient price movement for barrier-based predictions while maintaining enough consistency for reliable analysis.",
    },
  },
  {
    id: "over-under",
    ...
    howToUse: {
      ...
      tips: [
        ...
        "Monitor digit distribution changes throughout your session — what worked an hour ago may have shifted with Pivot Line",
        "Combine with confirm cycles set to 3 or higher for the most accurate threshold predictions",
        "Pivot Line trades on Vol 75 (1s) tend to have the clearest distribution patterns during active hours",
        "Use Take Profit to lock in gains — Pivot Line can be streaky, so securing profits at $30–$50 per session is recommended",
      ],
      recommended: "Vol 75 (1s) and Vol 100 (1s) show the clearest digit distribution patterns for Pivot Line analysis. Their higher volatility produces more pronounced digit biases, making threshold predictions more reliable.",
    },
  },
  {
    id: "deriv-r1",
    ...
    howToUse: {
      ...
      tips: ["Check back in the next update for the enhanced Precision Match experience"],
      recommended: "Use Quantum Sweep or Neural Strike as alternatives while Precision Match is being upgraded with new pattern recognition capabilities.",
    },
  },
  {
    id: "antiloss",
    ...
    howToUse: {
      ...
      tips: ["Use proper risk management with Take Profit settings in other strategies while Sentinel Guard is being updated"],
      recommended: "Use the Take Profit setting in Quantum Sweep, Neural Strike, or other active strategies to manage drawdowns while Sentinel Guard is undergoing its redesign.",
    },
  },
];
